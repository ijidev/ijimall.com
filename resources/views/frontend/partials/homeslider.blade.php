<div class="intro-slider-container">
    <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{"nav": false}'>
        ...
        <div class="intro-slide" style="background-image: url({{ asset('front_assets/assets/images/demos/demo-2/slider/slide-1.jpg') }});">
        ...
        <div class="intro-slide" style="background-image: url({{ asset('front_assets/assets/images/demos/demo-2/slider/slide-2.jpg') }});">
            <div class="container intro-content">
        ...
        <div class="intro-slide" style="background-image: url({{ asset('front_assets/assets/images/demos/demo-2/slider/slide-3.jpg') }});">
            <div class="container intro-content">
