        ...
        <div class="product-details-top">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="product-gallery product-gallery-vertical product-details sticky-content">
                        <div class="row">
                            <figure class="product-main-image">
                                <img id="product-zoom" src="{{ asset('front_assets/assets/images/products/single/1.jpg') }}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                ...
                <div class="col-md-6">
                    <div class="product-details sticky-content">
                        ...
                        <div class="product-price">
                            <span class="new-price">{{ $currency->symbol . number_format($product->price * $currency->rate, 2) }}</span>
                            <span class="old-price">{{$currency->symbol . number_format( 310.00 * $currency->rate, 2) }}</span>
