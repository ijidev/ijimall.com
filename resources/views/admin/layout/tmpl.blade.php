        ...
        <div class="main-wrapper main-wrapper-1">
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ '/admin/dashboard' }}"> <img alt="image"
                            ...
                            <span class="logo-name">IJIMall</span>
                        </a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="user-check"></i><span>Vendors</span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="{{ '/admin/vendor-payout' }}">Withdrawal</a></li>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    <a href="templateshub.net">Ijimall</a>
                </div>
