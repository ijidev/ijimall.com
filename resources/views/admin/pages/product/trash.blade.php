        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.restoreProduct', $product->id) }}" class="btn btn-link"><i class="fas fa-edit "></i>Restore</a>
                ...
                <nav class="d-inline-block">
                    <ul class="pagination mb-0">
                        <div class="form-group row m-2">
                            ...
                            <button type="submit" class="btn btn btn-primary col-4">Submit</button>
                        </div>
                    </ul>
                </nav>
            </div> 
